...
public class VolumeReduction_StablePrice_ma31 {
    ...
    /**
     * 趋势向上：31日均线支撑；量在5日、63日均量之下；J在5以下时拐头向上；
     */
    @Test
    ...
    /**
     * 趋势向上，31MA均线支撑（出现拐点）；量小于5日和63日均量；J值在0以下；
     */
    @Test
...
//        results = priceAnalyzer.getPositionUnder(31);
    ...
    /**
     * 趋势向上，31MA均线支撑（没有出现拐点）；量小于5日和63日均量；J值在0以下；
     */
    @Test
